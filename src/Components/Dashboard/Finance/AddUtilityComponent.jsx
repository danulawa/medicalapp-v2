...
class AddUtilityComponent extends Component {
    constructor(props){
        super(props)
        this.state={
        ...
        this.saveUtility = this.saveUtility.bind(this);
    }
            ...
            <div className="container">
                <div className="row">
                    <div className="card col-md-6 offset-md-3 offaet-md-3">
                        <h3 className="text-center">New Utility expencess</h3>
                        <div className="card-body">
                            ...
                            <div className="form-group">
                               ...
                               <div className="form-group">
                                ...
                                <button className="btn btn-success" onClick={this.saveUtility}>Save</button>
