...
class UpdateTimetableComponent extends Component {
    constructor(props) {
        super(props)
    ...
    componentDidMount(){
        TimetableServices.getTimetableByID(this.state.shiftID).then( (res) =>{
    ...
    updateTimetable = (e) => {
        e.preventDefault();
        let Timetable = {monday: this.state.monday,tuesday: this.state.tuesday,wednesday: this.state.wednesday,thursday: this.state.thursday,friday: this.state.friday,saturday: this.state.saturday,sunday: this.state.sunday};
        ...
        if(this.state.monday === ''){
            ...
            TimetableServices.updateTimetable(Timetable, this.state.shiftID).then(res => {
                   ...
                   <div className = "container">
                        <div className = "row">
                            <div className = "card col-md-6 offset-md-3 offset-md-3">
                                {
                                    <h3 className="text-center">Update Timetable Shift</h3>
                                }
                                <div className = "card-body">
                                    <form>
                                        ...
                                        <button className="btn btn-success" onClick={this.updateTimetable}>Update Shift</button>
...
export default UpdateTimetableComponent;