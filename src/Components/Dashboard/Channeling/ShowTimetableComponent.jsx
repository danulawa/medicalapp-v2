...
class ShowTimetableComponent extends Component {
    constructor(props) {
        super(props)
    ...
    editTimetable(shiftID){
        this.props.history.push(`/edit-timetables/${shiftID}`);
    }
    
    render() {
        return (
            <div>
                <h2 className="text-center">Employee Timetable Management</h2>
                <br></br>
                <div className = "row">
