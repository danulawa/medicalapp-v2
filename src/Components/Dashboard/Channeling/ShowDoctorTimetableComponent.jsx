...
class ShowDoctorTimetableComponent extends Component {
    constructor(props) {
        super(props)
    ...
    componentDidMount(){
        TimetableServices.getDocTimetable().then((res) => {
            this.setState({doctimetables: res.data});
        });
    }

    editTimetable(shiftID){
        this.props.history.push(`/edit-Doctimetables/${shiftID}`);
    }

    render() {
        return (
            <div>
                <h2 className="text-center">Doctor Timetable Management</h2>
                <br></br>
                <div className = "row">
                            ...
                            <tbody>
                                {
                                    this.state.doctimetables.map(
                                        ...
                                        <tr key = {timetable.shiftID}>
                                             ...
                                             <td> <button onClick={ () => this.editTimetable(timetable.shiftID)} className="btn btn-info">Update Shift</button></td>
                                        </tr>
                                    )
                                }
                            </tbody>
...
export default ShowDoctorTimetableComponent;